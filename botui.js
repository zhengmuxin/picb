...
!function(e, t) {
    ...
    return function(t, n) {
        ...
        e.Promise || Promise || options.promise || r("https://static.likepoems.com/cdn/common/botui/es6-promise.min.js");
        var w = {
        ...
        g.fontawesome && r("https://static.likepoems.com/cdn/common/botui/ea731dcb6f.js"),
        g.debug && (h._botApp = f),
        h
    }
});
...
function bot_ui_ini() {
    ...
    var sure = function() {
      ...
      , end = function() {
        botui.message.add({
            delay: 600,
            content: "![...](https://cdn.jsdelivr.net/gh/zhengmuxin/picb/gaoci.jpg)"
        })
    }
      , secondpart = function() {
        botui.message.add({
